        ...
        <div class="col-sm-6">
            <form method="post" action="{{ route('insertkriteria') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="kode" value="{!! ($kriteria->kode) !!}"/>
                </div>
                <div class="form-group">
                    <label>Nama Kriteria <span class="text-danger">*</span></label>
                    <input class="form-control" type="text" name="nama" value="{!! ($kriteria->kriteria) !!}"/>
                </div>
                <div class="form-group">
                    <label>Atribut <span class="text-danger">*</span></label>
                    <select class="form-control" name="atribut" id="id">
                        <option value="{!! ($kriteria->idatribut) !!}">{!! ($kriteria->atribut) !!}</option>
